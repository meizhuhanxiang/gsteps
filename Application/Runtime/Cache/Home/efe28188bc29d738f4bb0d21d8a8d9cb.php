...
<body >
<img src="<?php echo ($_SESSION["profile"]); ?>" alt="头像" class="img-circle" style="margin-left:auto; margin-right:auto;"/>
<div style="padding: 100px 100px 10px;">
   <form class="bs-example bs-example-form" role="form" action="<?php echo U('Index/register');?>" method="post">
      ...
      <div class="input-group">
         <span class="input-group-addon">@</span>
         <input type="text" id="job" name="job" class="form-control" placeholder="职务" value="">
      </div><br>
      <div class="input-group">
         <span class="input-group-addon">@</span>
         <input type="text" id="email" name="email" class="form-control" placeholder="邮箱" value="">
      </div><br>
      <div class="input-group">
         <span class="input-group-addon">@</span>
         <input type="text" id="mobile" name="mobile" class="form-control" placeholder="手机" value="">
      </div><br>
      <div class="input-group">
         <span class="input-group-addon">@</span>
         <input type="text" id="wechat" name="wechat" class="form-control" placeholder="微信" value="">
      </div><br>
